...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Chart1, 121);
    lv_obj_set_height(ui_Chart1, 157);
    ...
    lv_chart_set_range(ui_Chart1, LV_CHART_AXIS_PRIMARY_Y, -100000, 100000);
    ...
    // lv_chart_series_t * ui_Chart1_series_1 = lv_chart_add_series(ui_Chart1, lv_color_hex(0x56D11F),
